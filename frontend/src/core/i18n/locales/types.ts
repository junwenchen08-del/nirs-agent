...
export interface Translations {
  ...
  settings: {
    ...
    knowledge: {
      ...
      searchButton: string;
      searchEmpty: string;
      searchAbstained: string;
      searchReasonLowScore: string;
      searchReasonAmbiguous: string;
      searchReasonNoCandidates: string;
      searchTopScore: string;
      columnTitle: string;
      columnSource: string;
      columnYear: string;
      columnChunks: string;
      ...
      editButton: string;
      editMetadataTitle: string;
      editMetadataDescription: string;
      saveMetadataButton: string;
      savingMetadataButton: string;
      metadataUpdateSuccess: string;
