  ...
  settings: {
    ...
    knowledge: {
      ...
      deleteConfirmDescription:
        "This will permanently delete the document and all its chunks. This cannot be undone. To update content, delete and re-upload.",
      deleteSuccess: "Deleted document: {docId}",
      deleteFailed: "Delete failed: {message}",
      refreshButton: "Refresh",
      searchTitle: "Search Test",
      searchPlaceholder: "Enter a query, e.g.: SNV vs MSC differences",
      searchButton: "Search",
      searchEmpty: "No search results.",
      searchAbstained:
        "No sufficiently reliable evidence was found, so potentially unrelated matches were withheld.",
      searchReasonLowScore:
        "The best similarity score was below the minimum confidence threshold.",
      searchReasonAmbiguous:
        "Several documents scored too similarly to identify a reliable source.",
      searchReasonNoCandidates: "The knowledge base returned no candidates.",
      searchTopScore: "Top similarity",
      columnTitle: "Title",
      columnSource: "Source",
      columnYear: "Year",
      columnChunks: "Chunks",
      columnStatus: "Status",
      columnMethods: "Methods",
      columnActions: "Actions",
      publishButton: "Publish",
      publishingButton: "Publishing...",
      publishSuccess: "Published document: {title}",
      publishFailed: "Publication failed: {message}",
      editButton: "Edit",
      editMetadataTitle: "Edit document metadata",
      editMetadataDescription:
        "Changes are synchronized to the catalog and existing vector chunks without reparsing or re-embedding the document.",
      saveMetadataButton: "Save",
      savingMetadataButton: "Saving...",
      metadataUpdateSuccess: "Updated document metadata: {title}",
      metadataUpdateFailed: "Metadata update failed: {message}",
      authorsLabel: "Authors",
      authorsPlaceholder: "Separate multiple authors with commas",
      doiLabel: "DOI",
      doiPlaceholder: "e.g. 10.1000/example",
      languageLabel: "Language",
      languagePlaceholder: "e.g. zh, en, or zh-en",
      domainsLabel: "Domain tags",
      domainsPlaceholder: "Separate multiple tags with commas",
      qualityTierLabel: "Quality tier",
      invalidYear: "Year must be an integer between 1000 and 2100.",
      statusDraft: "Draft",
      statusNeedsReview: "Needs review",
      statusPublished: "Published",
      statusRetired: "Retired",
      titleLabel: "Title (optional)",
      titlePlaceholder: "Defaults to filename if empty",
