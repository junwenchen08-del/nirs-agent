...
export const zhCN: Translations = {
  ...
  settings: {
    ...
    knowledge: {
      ...
      searchButton: "搜索",
      searchEmpty: "暂无搜索结果。",
      searchAbstained: "未找到足够可靠的证据，已拒绝返回可能无关的片段。",
      searchReasonLowScore: "最高相似度低于最低可信阈值。",
      searchReasonAmbiguous: "多个文档的相似度过于接近，无法确认答案来源。",
      searchReasonNoCandidates: "知识库中没有可用候选片段。",
      searchTopScore: "最高相似度",
      columnTitle: "标题",
      columnSource: "来源",
      columnYear: "年份",
      columnChunks: "分块数",
      ...
      publishSuccess: "已发布文档：{title}",
      publishFailed: "发布失败：{message}",
      editButton: "编辑",
      editMetadataTitle: "编辑文档元数据",
      editMetadataDescription:
        "修改会同步到文档目录和现有向量分块，不会重新解析文档或生成向量。",
      saveMetadataButton: "保存",
      savingMetadataButton: "保存中...",
      metadataUpdateSuccess: "已更新文档元数据：{title}",
      metadataUpdateFailed: "元数据更新失败：{message}",
      authorsLabel: "作者",
      authorsPlaceholder: "多位作者用逗号分隔",
      doiLabel: "DOI",
      doiPlaceholder: "例如 10.1000/example",
      languageLabel: "语言",
      languagePlaceholder: "例如 zh、en 或 zh-en",
      domainsLabel: "领域标签",
      domainsPlaceholder: "多个标签用逗号分隔",
      qualityTierLabel: "质量等级",
      invalidYear: "年份必须是 1000 到 2100 之间的整数。",
      statusDraft: "草稿",
