...
export const zhCN: Translations = {
  ...
  settings: {
    ...
    knowledge: {
      title: "知识库",
      description:
        "管理 NIR 近红外知识库中的文档。上传的论文会自动解析、分块、提取实体并建立向量索引，供智能体检索引用。",
      empty: "知识库为空。点击上方按钮上传第一篇文档。",
      statsDocuments: "文档数",
      statsChunks: "分块数",
      uploadButton: "上传文档",
      ...
      deleteConfirmDescription:
        "此操作将永久删除该文档及其所有分块，无法撤销。如需更新内容，请删除后重新上传。",
      deleteSuccess: "已删除文档：{docId}",
      deleteFailed: "删除失败：{message}",
      refreshButton: "刷新",
      searchTitle: "搜索测试",
      searchPlaceholder: "输入查询内容，例如：SNV 与 MSC 的区别",
      searchButton: "搜索",
      searchEmpty: "暂无搜索结果。",
      columnTitle: "标题",
      columnSource: "来源",
